...
if __name__ == "__main__":
    ...
    np.save(save_to + '_X_Single.npy', X)
    np.save(save_to + '_Y_Single.npy', Y)
    np.save(save_to + '_ENCDEC_Single.npy', enc_dec)
